---
layout: post
title:  "Linux 5.0 arm32 Usermanual"
date:   2019-03-04 18:11:30 +0800
categories: [Build]
...
>
> - [配置 Linux 5.0 arm32 内核](#配置 Linux 5.0 arm32 内核)
>
> - [编译 Linux 5.0 arm32 内核](#编译 Linux 5.0 arm32 内核)
>
> - [运行 Linux 5.0 arm32 内核](#运行 Linux 5.0 arm32 内核)
>
> - [驱动开发](#驱动开发)
>
> - [调试 Linux 5.0 arm32 内核](#Linux 5.0 arm32 内核调试)
>
> - [附录](#附录)
...
获得 BiscuitOS 项目之后，可以使用 BiscuitOS 构建 Linux 5.0 arm32 的开发环境。开发者
只需执行如下命令就可以获得 Linux 5.0 arm32 完整的 BiscuitOS，如下：
...
#### <span id="配置 Linux 5.0 arm32 内核">配置 Linux 5.0 arm32 内核</span>
...
![BiscuitOS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/BUDX000304.png)

选择 **General setup**

![BiscuitOS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/BUDX000305.png)

选中 **Initial RAM filesystem and RAM disk (initramfs/initrd) support**

![BiscuitOS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/BUDX000306.png)

选择 **Device Driver**

![BiscuitOS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/BUDX000307.png)

选择 **Block devices**

![BiscuitOS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/BUDX000308.png)

选中 **RAM block device support**, 并设置 **Default RAM disk size** 的大小为 
153600 . 保存并退出，至此，Linux 配置完成。

#### <span id="编译 Linux 5.0 arm32 内核">编译 Linux 5.0 arm32 内核</span>
...
![BiscuitOS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/BUDX000309.png)
...
![BiscuitOS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/BUDX000003.png)

选择 **Busybox Settings --->**

![BiscuitOS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/BUDX000004.png)

选择 **Build Options --->**

![BiscuitOS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/BUDX000005.png)
...
#### <span id="运行 Linux 5.0 arm32 内核">运行 Linux 5.0 arm32 内核</span>

完成上面的步骤之后，开发者就可以运行 Linux 5.0 arm32 内核，使用如下命令即可：
...
![BiscuitOS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/BUDX000310.png)

至此，一个 Linux 5.0 arm32 内核已经运行，开发者可以根据自己兴趣和需求对内核进行魔改。
...
持 Linux 5.0 arm32 内核驱动的开发。开发者可以参照下面方法进行更多驱动开发。
...
![BiscuitOS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/BUDX000311.png)

首先在目录中找到 **Device Driver --->** 回车并进入其中。

![BiscuitOS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/BUDX000312.png)

接着在目录中找到 **BiscuitOS Driver --->** 按 Y 选中并按回车键进入。

![BiscuitOS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/BUDX000313.png)
...
![BiscuitOS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/BUDX000100.jpg)
...
![BiscuitOS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/BUDX000314.png)
...
# <span id="Linux 5.0 arm32 内核调试">Linux 5.0 arm32 内核调试</span>
...
![BiscuitOS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/BUDX000315.png)
...
![BiscuitOS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/BUDX000316.png)
