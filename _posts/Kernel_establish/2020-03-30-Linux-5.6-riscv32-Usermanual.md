---
layout: post
title:  "Linux 5.6 riscv32 Usermanual"
...
至此，BiscuitOS 已经部署完毕.
BiscuitOS 目前已经支持 5.6 riscv32 的开发部署，开发者在
...
执行上面的命令之后，BiscuitOS 项目就会自动部署 "linux 5.6 riscv32"
...
在上面的输出信息中，指出了 "linux 5.6 riscv32" 项目
...
{% highlight bash %}
make ARCH=arm CROSS_COMPILE=BiscuitOS/output/linux-5.6-riscv32/riscv32-biscuitos-linux-gnu/riscv32-biscuitos-linux-gnu/bin/riscv32-biscuitos-linux-gnu- -j8
make ARCH=arm CROSS_COMPILE=BiscuitOS/output/linux-5.6-riscv32/riscv32-biscuitos-linux-gnu/riscv32-biscuitos-linux-gnu/bin/riscv32-biscuitos-linux-gnu- dtbs
{% endhighlight %}
...
{% highlight bash %}
make CROSS_COMPILE=BiscuitOS/output/linux-5.6-riscv32/riscv32-biscuitos-linux-gnu/riscv32-biscuitos-linux-gnu/bin/riscv32-biscuitos-linux-gnu- -j8

make CROSS_COMPILE=BiscuitOS/output/linux-5.6-riscv32/riscv32-biscuitos-linux-gnu/riscv32-biscuitos-linux-gnu/bin/riscv32-biscuitos-linux-gnu- install
{% endhighlight %}
...
{% highlight bash %}
make ARCH=arm CROSS_COMPILE=BiscuitOS/output/linux-5.6-riscv32/riscv32-biscuitos-linux-gnu/riscv32-biscuitos-linux-gnu/bin/riscv32-biscuitos-linux-gnu- modules -j4
make ARCH=arm INSTALL_MOD_PATH=BiscuitOS/output/linux-5.6-riscv32/rootfs/rootfs/ modules_install
{% endhighlight %}
...
{% highlight bash %}
BiscuitOS/output/linux-5.6-riscv32/riscv32-biscuitos-linux-gnu/riscv32-biscuitos-linux-gnu/bin/riscv32-biscuitos-linux-gnu-gdb BiscuitOS/output/linux-5.6-riscv32/linux/linux/vmlinux
{% endhighlight %}
