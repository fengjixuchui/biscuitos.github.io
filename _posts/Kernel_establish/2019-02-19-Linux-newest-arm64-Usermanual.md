---
layout: post
title:  "Linux newest arm64 Usermanual"
date:   2019-02-19 15:06:30 +0800
categories: [Build]
excerpt: Linux newest arm64 Usermanual.
tags:
  - Linux
---
...
>
> - [配置 Linux newest arm64 内核](#配置 Linux newest arm64 内核)
>
> - [编译 Linux newest arm64 内核](#编译 Linux newest arm64 内核)
>
> - [运行 Linux newest arm64 内核](#运行 Linux newest arm64 内核)
>
> - [驱动开发](#驱动开发)
>
> - [调试 Linux newest arm64 内核](#Linux newest arm64 内核调试)
>
> - [附录](#附录)
...
获得 BiscuitOS 项目之后，可以使用 BiscuitOS 构建 Linux newest arm64 的开发环境。开发者
只需执行如下命令就可以获得 Linux newest arm64 完整的 BiscuitOS，如下：

{% highlight bash %}
cd BiscuitOS
make linux-newest-arm64_defconfig
make
{% endhighlight %}
...
***********************************************
Output:
 BiscuitOS/output/linux-newest-arm64 

linux:
 BiscuitOS/output/linux-newest-arm64/linux/linux 

README:
 BiscuitOS/output/linux-newest-arm64/README.md 
...
```
cd BiscuitOS/output/linux-newest-arm64/linux/linux
...
make ARCH=arm64 CROSS_COMPILE=BiscuitOS/output/linux-newest-arm64/aarch64-linux-gnu/aarch64-linux-gnu/bin/aarch64-linux-gnu- Image -j8
```

# Build Busybox

```
cd BiscuitOS/output/linux-newest-arm64/busybox/busybox
make clean
make menuconfig
  Busybox Settings --->
    Build Options --->
...
make CROSS_COMPILE=BiscuitOS/output/linux-newest-arm64/aarch64-linux-gnu/aarch64-linux-gnu/bin/aarch64-linux-gnu- -j8

make CROSS_COMPILE=BiscuitOS/output/linux-newest-arm64/aarch64-linux-gnu/aarch64-linux-gnu/bin/aarch64-linux-gnu- install
```
...
```
cd BiscuitOS/output/linux-newest-arm64
...
```
BiscuitOS/output/linux-newest-arm64/aarch64-linux-gnu/aarch64-linux-gnu/bin/aarch64-linux-gnu-gdb BiscuitOS/output/linux-newest-arm64/linux/linux/vmlinux
...
#### <span id="配置 Linux newest arm64 内核">配置 Linux newest arm64 内核</span>
...
![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000117.png)

选择 **General setup**

![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000118.png)

选中 **Initial RAM filesystem and RAM disk (initramfs/initrd) support**

![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000119.png)

选择 **Device Driver**

![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000120.png)

选择 **Block devices**

![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000121.png)

选中 **RAM block device support**, 并设置 **Default RAM disk size** 的大小为 
153600 . 保存并退出，至此，Linux 配置完成。

#### <span id="编译 Linux newest arm64 内核">编译 Linux newest arm64 内核</span>
...
![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000122.png)
...
#### <span id="运行 Linux newest arm64 内核">运行 Linux newest arm64 内核</span>

完成上面的步骤之后，开发者就可以运行 Linux newest arm64 内核，使用如下命令即可：
...
![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000123.png)

至此，一个 Linux newest arm64 内核已经运行，开发者可以根据自己兴趣和需求对内核进行魔改。
...
持 Linux newest arm64 内核驱动的开发。开发者可以参照下面方法进行更多驱动开发。
...
![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000124.png)

首先在目录中找到 **Device Driver --->** 回车并进入其中。

![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000125.png)

接着在目录中找到 **BiscuitOS Driver --->** 按 Y 选中并按回车键进入。

![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000126.png)
...
![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000127.png)
...
# <span id="Linux newest arm64 内核调试">Linux newest arm64 内核调试</span>
...
![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000128.png)
...
![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000129.png)
