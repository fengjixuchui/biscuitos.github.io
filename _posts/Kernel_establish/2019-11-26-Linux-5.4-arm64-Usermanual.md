...
{% highlight bash %}
make ARCH=arm CROSS_COMPILE=BiscuitOS/output/linux-5.4-arm64/aarch64-linux-gnu/aarch64-linux-gnu/bin/aarch64-linux-gnu-
{% endhighlight %}
...
{% highlight bash %}
make ARCH=arm CROSS_COMPILE=BiscuitOS/output/linux-5.4-arm64/aarch64-linux-gnu/aarch64-linux-gnu/bin/aarch64-linux-gnu- -j8
make ARCH=arm CROSS_COMPILE=BiscuitOS/output/linux-5.4-arm64/aarch64-linux-gnu/aarch64-linux-gnu/bin/aarch64-linux-gnu- dtbs
{% endhighlight %}
...
![](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/RPI/Linux-5.4-arm64.png)
...
{% highlight bash %}
make ARCH=arm CROSS_COMPILE=BiscuitOS/output/linux-5.4-arm64/aarch64-linux-gnu/aarch64-linux-gnu/bin/aarch64-linux-gnu- modules -j4
make ARCH=arm INSTALL_MOD_PATH=BiscuitOS/output/linux-5.4-arm64/rootfs/rootfs/ modules_install
{% endhighlight %}
