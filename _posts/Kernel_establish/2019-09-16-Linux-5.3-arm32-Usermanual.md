---
layout: post
title:  "Linux 5.3 arm32 Usermanual"
date:   2019-05-06 14:45:30 +0800
categories: [Build]
excerpt: Linux 5.3 arm32 Usermanual.
tags:
  - Linux
---
...
更多有趣的可能，开发者在使用 BiscuitOS 构建 Linux 5.3
的系统之前，需要做好如下准备:
...
至此，BiscuitOS 已经部署完毕.
BiscuitOS 目前已经支持 5.3 arm32 的开发部署，开发者在
部署完 BiscuitOS 环境之后，可以参考下面命令进行部署:

{% highlight bash %}
cd BiscuitOS
make linux-5.3-arm32_defconfig
make
cd BiscuitOS/output/linux-5.3-arm32
{% endhighlight %}

执行上面的命令之后，BiscuitOS 项目就会自动部署 "linux 5.3 arm32"
...
***********************************************
Output:
 BiscuitOS/output/linux-5.3-

linux:
 BiscuitOS/output/linux-5.3-arm32/linux/linux 

README:
 BiscuitOS/output/linux-5.3-arm32/README.md 

***********************************************
{% endhighlight %}

在上面的输出信息中，指出了 "linux 5.3 arm32" 项目
的目录位置，以及 linux 源码目录，更重要的是各个模块
编译规则，开发者应该重点参考 README.md 的内容.

![](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/RPI/RPI000110.png)
...
要确定 "linux 5.3 arm32" 项目项目是否支持 bootloader 源码
编译，请参考 "[BiscuitOS 部署](#A11)" 一节中自动生成的 "README.md"
文档。如果文档中有关于 "Build Uboot" 章节，那么 "linux 5.3 arm32"
...
开发者首先参考 "linux 5.3 arm32" 项目生成的 README.md 文档，
...
![](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/RPI/RPI000111.png)
...
参考 "linux 5.3 arm32" 项目生成的 README.md 文档，例如:

{% highlight bash %}
make ARCH=arm CROSS_COMPILE=BiscuitOS/output/linux-5.3-arm32/arm-linux-gnueabi/arm-linux-gnueabi/bin/arm-linux-gnueabi-
{% endhighlight %}

![](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/RPI/RPI000112.png)
...
工作，可以参考 "linux 5.3 arm32" 项目生成的 README.md 文档，
例如:
...
![](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/RPI/RPI000113.png)
...
{% highlight bash %}
cd BiscuitOS/output/linux-5.3-arm32/linux/linux
make ARCH=arm clean
make ARCH=arm vexpress_defconfig
make ARCH=arm menuconfig
{% endhighlight %}

![](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/RPI/RPI000114.png)
...
{% highlight bash %}
make ARCH=arm CROSS_COMPILE=BiscuitOS/output/linux-5.3-arm32/arm-linux-gnueabi/arm-linux-gnueabi/bin/arm-linux-gnueabi- -j8
make ARCH=arm CROSS_COMPILE=BiscuitOS/output/linux-5.3-arm32/arm-linux-gnueabi/arm-linux-gnueabi/bin/arm-linux-gnueabi- dtbs
{% endhighlight %}

![](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/RPI/RPI000115.png)
...
{% highlight bash %}
cd BiscuitOS/output/linux-5.3-arm32/busybox/busybox
make clean
make menuconfig
{% endhighlight %}
...
{% highlight bash %}
make CROSS_COMPILE=BiscuitOS/output/linux-5.3-arm32/arm-linux-gnueabi/arm-linux-gnueabi/bin/arm-linux-gnueabi- -j8

make CROSS_COMPILE=BiscuitOS/output/linux-5.3-arm32/arm-linux-gnueabi/arm-linux-gnueabi/bin/arm-linux-gnueabi- install
{% endhighlight %}
...
![](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/RPI/Linux-5.3-arm32.png)
...
首先开发者应该准备基于 Linux 5.3 arm32 开发环境，然后
...
{% highlight bash %}
make
cd BiscuitOS/output/linux-5.3-arm32/package/LDD_platform_core_module-0.0.1/
make prepare
make download
make
make install
...
{% highlight bash %}
make ARCH=arm CROSS_COMPILE=BiscuitOS/output/linux-5.3-arm32/arm-linux-gnueabi/arm-linux-gnueabi/bin/arm-linux-gnueabi- modules -j4
make ARCH=arm INSTALL_MOD_PATH=BiscuitOS/output/linux-5.3-arm32/rootfs/rootfs/ modules_install
{% endhighlight %}
...
{% highlight bash %}
cd lib/modules/5.3.0/kernel/driver/BiscuitOS/
insmod misc.ko
{% endhighlight %}
...
{% highlight bash %}
BiscuitOS/output/linux-5.3-arm32/arm-linux-gnueabi/arm-linux-gnueabi/bin/arm-linux-gnueabi-gdb BiscuitOS/output/linux-5.3-arm32/linux/linux/vmlinux
{% endhighlight %}
