---
layout: post
title:  "Linux 3.4.29 arm32 Usermanual"
date:   2019-02-20 10:30:30 +0800
categories: [Build]
excerpt: Linux 3.4.29 arm32 Usermanual.
tags:
  - Linux
---
...
>
> - [配置 Linux 3.4.29 arm32 内核](#配置 Linux 3.4.29 arm32 内核)
>
> - [编译 Linux 3.4.29 arm32 内核](#编译 Linux 3.4.29 arm32 内核)
>
> - [运行 Linux 3.4.29 arm32 内核](#运行 Linux 3.4.29 arm32 内核)
>
> - [驱动开发](#驱动开发)
>
> - [调试 Linux 3.4.29 arm32 内核](#Linux 3.4.29 arm32 内核调试)
>
> - [附录](#附录)
...
获得 BiscuitOS 项目之后，可以使用 BiscuitOS 构建 Linux 3.4.29 arm32 的开发环境。开发者
只需执行如下命令就可以获得 Linux 3.4.29 arm32 完整的 BiscuitOS，如下：

{% highlight bash %}
cd BiscuitOS
make linux-3.4.29-arm32_defconfig
make
{% endhighlight %}
...
***********************************************
Output:
 BiscuitOS/output/linux-3.4.29 

linux:
 BiscuitOS/output/linux-3.4.29/linux/linux 

README:
 BiscuitOS/output/linux-3.4.29/README.md 
...
```
cd BiscuitOS/output/linux-3.4.29/linux/linux
make ARCH=arm clean
...
make ARCH=arm CROSS_COMPILE=BiscuitOS/output/linux-3.4.29/arm-linux-gnueabi/arm-linux-gnueabi/bin/arm-linux-gnueabi- -j8
```

# Build Busybox

```
cd BiscuitOS/output/linux-3.4.29/busybox/busybox
make clean
make menuconfig
  Busybox Settings --->
    Build Options --->
...
make CROSS_COMPILE=BiscuitOS/output/linux-3.4.29/arm-linux-gnueabi/arm-linux-gnueabi/bin/arm-linux-gnueabi- -j8

make CROSS_COMPILE=BiscuitOS/output/linux-3.4.29/arm-linux-gnueabi/arm-linux-gnueabi/bin/arm-linux-gnueabi- install
```
...
```
cd BiscuitOS/output/linux-3.4.29
...
```
BiscuitOS/output/linux-3.4.29/arm-linux-gnueabi/arm-linux-gnueabi/bin/arm-linux-gnueabi-gdb BiscuitOS/output/linux-3.4.29/linux/linux/vmlinux
...
#### <span id="配置 Linux 3.4.29 arm32 内核">配置 Linux 3.4.29 arm32 内核</span>
...
![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000184.png)

选择 **General setup**

![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000185.png)

选中 **Initial RAM filesystem and RAM disk (initramfs/initrd) support**

![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000186.png)

选择 **Device Driver**

![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000187.png)

选择 **Block devices**

![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000188.png)

选中 **RAM block device support**, 并设置 **Default RAM disk size** 的大小为 
153600 . 

![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000191.png)

选择 **File systems**

![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000192.png)

选中 **The Extended 4 (ext4) filesystem**

![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000189.png)

选择 **Enable the block layer**

![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000190.png)
...
#### <span id="编译 Linux 3.4.29 arm32 内核">编译 Linux 3.4.29 arm32 内核</span>
...
![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000200.png)
...
#### <span id="运行 Linux 3.4.29 arm32 内核">运行 Linux 3.4.29 arm32 内核</span>

完成上面的步骤之后，开发者就可以运行 Linux 3.4.29 arm32 内核，使用如下命令即可：
...
![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000193.png)

至此，一个 Linux 3.4.29 arm32 内核已经运行，开发者可以根据自己兴趣和需求对内核进行魔改。
...
持 Linux 3.4.29 arm32 内核驱动的开发。开发者可以参照下面方法进行更多驱动开发。
...
![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000194.png)

首先在目录中找到 **Device Driver --->** 回车并进入其中。

![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000195.png)

接着在目录中找到 **BiscuitOS Driver --->** 按 Y 选中并按回车键进入。

![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000196.png)
...
# <span id="Linux 3.4.29 arm32 内核调试">Linux 3.4.29 arm32 内核调试</span>
...
![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000198.png)
...
![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000199.png)
