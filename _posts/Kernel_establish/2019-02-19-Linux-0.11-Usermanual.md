---
layout: post
title:  "BiscuitOS Linux 0.11 i386 Usermanual"
date:   2020-10-02 14:45:30 +0800
categories: [Build]
excerpt: Linux 0.11 i386 Usermanual.
tags:
  - Linux
---
...
BiscuitOS 项目是一个用于制作 Linux 0.x、1.x、2.x、3.x、4.x、0.11
...
BiscuitOS 源码下载完毕后，使用 BiscuitOS 自动部署功能，部署一个 Linux 0.11 
i386 的开发部署，使用自动部署功能之后，BiscuitOS 项目会自动下载并部署 Linux 
0.11 i386 所需的源码和编译工具等，可能需要一些时间，请保持网络的通畅. 开发者
参考下面命令进行部署:
...
make
cd BiscuitOS/output/linux-0.11
{% endhighlight %}

成功执行之后，BiscuitOS 输出 Linux 0.11 i386 项目目录，以及对应内核的目录，并且
自动生成 BiscuitOS Linux 0.11 i386 用户手册 (README)，开发者应该重点参考该 
README.md.
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/BUDX000021.png)
