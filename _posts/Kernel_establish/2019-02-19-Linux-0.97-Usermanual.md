---
layout: post
title:  "linux 0.97 Usermanual"
date:   2019-02-19 08:55:30 +0800
categories: [Build]
excerpt: linux 0.97 Usermanual.
tags:
  - Linux
---
...
>
> - [运行 linux 0.97 内核](#运行 linux 0.97 内核)
>
> - [配置 linux 0.97 内核](#配置 linux 0.97 内核)
>
> - [编译 linux 0.97 内核](#编译 linux 0.97 内核)
>
> - [调试 linux 0.97 内核](#linux 0.97 内核调试)
>
> - [附录](#附录)
...
获得 BiscuitOS 项目之后，可以使用 BiscuitOS 构建 linux 0.97 的开发环境。开发者
只需执行如下命令就可以获得 linux 0.97 完整的 BiscuitOS，如下：

{% highlight bash %}
cd BiscuitOS
make linux-0.97_defconfig
make
{% endhighlight %}
...
*******************************************************************
Kernel Path:
 BiscuitOS/output/linux-0.97.1/linux/linux/ 

README:
 BiscuitOS/output/linux-0.97.1/README.md 
...
{% highlight bash %}
Linux-0.97.1 Usermanual
----------------------------

# Build Kernel

```
cd BiscuitOS/output/linux-0.97.1/linux/linux
make
```
...
#### <span id="运行 linux 0.97 内核">运行 linux 0.97 内核</span>

完成上面的步骤之后，开发者就可以运行 linux 0.97 内核，使用如下命令即可：
...
![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000047.png)

#### <span id="配置 linux 0.97 内核">配置 linux 0.97 内核</span>

linux 0.97 内核源码由 Kbuild 构建，开发者也可以配置 Linux 内核，使用如下命令：
...
![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000048.png)

#### <span id="编译 linux 0.97 内核">编译 linux 0.97 内核</span>
...
![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000049.png)

至此，一个 linux 0.97 内核已经运行，开发者可以根据自己兴趣和需求对内核进行魔改。

-----------------------------------------------------

# <span id="linux 0.97 内核调试">linux 0.97 内核调试</span>
...
![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000050.png)

![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/BUDX000051.png)
