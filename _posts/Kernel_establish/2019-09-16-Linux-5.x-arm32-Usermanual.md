...
>
> - [配置 Linux 5.x arm32 内核](#配置 Linux 5.x arm32 内核)
>
> - [编译 Linux 5.x arm32 内核](#编译 Linux 5.x arm32 内核)
>
> - [运行 Linux 5.x arm32 内核](#运行 Linux 5.x arm32 内核)
>
> - [驱动开发](#驱动开发)
>
> - [调试 Linux 5.x arm32 内核](#Linux 5.x arm32 内核调试)
>
> - [附录](#附录)
...
获得 BiscuitOS 项目之后，可以使用 BiscuitOS 构建 Linux 5.x arm32 的开发环境。开发者
只需执行如下命令就可以获得 Linux 5.x arm32 完整的 BiscuitOS，如下：
...
***********************************************
Output:
 BiscuitOS/output/linux-5.x-arm32
...
#### <span id="配置 Linux 5.x arm32 内核">配置 Linux 5.x arm32 内核</span>
...
#### <span id="编译 Linux 5.x arm32 内核">编译 Linux 5.x arm32 内核</span>
...
#### <span id="运行 Linux 5.x arm32 内核">运行 Linux 5.x arm32 内核</span>

完成上面的步骤之后，开发者就可以运行 Linux 5.x arm32 内核，使用如下命令即可：
...
至此，一个 Linux 5.x arm32 内核已经运行，开发者可以根据自己兴趣和需求对内核进行魔改。
...
持 Linux 5.x arm32 内核驱动的开发。开发者可以参照下面方法进行更多驱动开发。
...
# <span id="Linux 5.x arm32 内核调试">Linux 5.x arm32 内核调试</span>
