...
![](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/RPI/Linux-5.x-arm32.png)
...
{% highlight bash %}
make
cd BiscuitOS/output/linux-5.x-arm32/package/LDD_platform_core_module-0.0.1/
make prepare
make download
make
make install
