---
layout: post
title:  "Linux 5.6 x86_64 Usermanual"
...
至此，BiscuitOS 已经部署完毕.
BiscuitOS 目前已经支持 5.6 x86_64 的开发部署，开发者在
...
执行上面的命令之后，BiscuitOS 项目就会自动部署 "linux 5.6 x86_64"
...
在上面的输出信息中，指出了 "linux 5.6 x86_64" 项目
...
选中 **Build BusyBox as a static binary (no shared libs)**， 保存并
退出。使用如下命令编译 BusyBox
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/RPI/RPI000602.png)
