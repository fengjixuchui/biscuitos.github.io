---
layout: post
title:  "radix_tree_chunk_size"
date:   2019-05-29 05:30:30 +0800
categories: [HW]
excerpt: Radix-Tree radix_tree_chunk_size().
tags:
  - Radix-Tree
---
...
> [Github: radix_tree_chunk_size](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/tree/radix-tree/API/radix_tree_chunk_size)
>
...
radix_tree_chunk_size() 函数用于获得当前层的 chunk size。函数使用 radix_tree_iter
的 next_index 减去 index 以此获得当前层的 chunk size。
