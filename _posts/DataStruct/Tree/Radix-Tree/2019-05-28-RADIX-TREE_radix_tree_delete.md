---
layout: post
title:  "radix_tree_delete"
date:   2019-05-29 05:30:30 +0800
categories: [HW]
excerpt: Radix-Tree radix_tree_delete().
tags:
  - Radix-Tree
---
...
> [Github: radix_tree_delete](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/tree/radix-tree/API/radix_tree_delete)
>
...
radix_tree_delete() 函数用于根据 index 从 radix tree 中删除指定的节点。函数直接
调用 radix_tree_delete_item() 函数进行节点的删除。
...
static __init int radix_demo_init(void)
{
	...
	radix_tree_delete(&BiscuitOS_root, 0x60000);
