---
layout: post
title:  "rb_insert_color"
date:   2019-05-21 05:30:30 +0800
categories: [HW]
excerpt: RB-Tree rb_insert_color().
tags:
  - RBTREE
---
...
rb_insert_color() 函数用于将一个 rb_node 插入到红黑树里，并对红黑树进行调整，
使红黑树再次达到平衡。函数直接调用 __rb_insert() 函数，该函数用于实际的插入操作，
包括红黑树的旋转和颜色翻转，具体可以查看文档：

> [红黑树插入操之 rb_insert_color]()
...
红黑树插入节点时，内核提供的接口函数。使用该函数就能插入一个 rb_node 到红黑树里。
