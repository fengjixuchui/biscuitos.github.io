...
> [Github: rb_entry](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/tree/rb-tree/API/rb_entry)
>
...
rb_entry() 函数用于获得包含 struct rb_node 的结构。这是一个很有用的函数，通过
这个函数就可以轻松获得包含的数据结构。
...
当开发者向获得红黑树节点对应的结构，可以使用 rb_entry() 函数。
