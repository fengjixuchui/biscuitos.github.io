---
layout: post
title:  "rb_first_postorder"
date:   2019-05-23 05:30:30 +0800
categories: [HW]
excerpt: RB-Tree rb_first_postorder().
tags:
  - RBTREE
---
...
> [Github: rb_first_postorder](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/tree/rb-tree/API/rb_first_postorder)
>
...
rb_first_postorder() 函数用于获得后序遍历的第一个 rb_node. 函数首先判断
根节点是否存在，如果不存在，则返回 NULL；如果根节点存在，则调用
rb_left_deepest_node() 函数获得根节点最左孩子。
