...
![DTS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000081.png)

比如上图单个4节点，只需将中间节点往上提，左边值作为其左子树，右边值作为其右子树即可。

![DTS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000082.png)

------------------------------------------

### <span id="节点合并">节点合并</span>

![DTS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000084.png)

比如有父节点的 4 节点，节点分裂后，需与父节点进行合并。若合并后父节点还是 4 节点，
则继续分裂，直至满足定义为止。上图中16 与 36 合并后，满足条件，无需再进行操作。

![DTS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000086.png)
...
![DTS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000079.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000116.png)

在上图中，准备插入 12 节点，首先没有找到空的子节点可以插入，那么就找 9 节点进行融合，
由于 9 节点是一个 2- 节点，因此可以直接融合，此时如何 2-3 树的要求，不需要做其他操作。

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000117.png)
...
![A](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000117.png)

向上图中插入 13，此时找到了 "9-12" 节点，融合之后形成一个临时的 4- 节点，如下图：

![B](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000118.png)

此时临时 4- 节点不能满足 2-3 树的要求，因此需要对 12 节点进行分离，分离之后，由于
父节点 8 是一个 2- 节点，因此与父节点进行融合，形成 "8-12" 3- 节点，如下图：

![C](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000119.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000120.png)

如上图，向 "14-20" 3- 节点中插入 18，此时构成了一个临时的 4- 节点，如下图：

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000121.png)

此时需要对临时 4- 节点进行分离和提取，将 14,18,20 分离成 3 个 2- 节点，然后将 18
节点向上融合，此时父节点 "8-12" 是一个 3- 节点，与 18 融合之后，形成了一个临时 4-
节点，

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000122.png)

"8-12-18" 组成了一个临时的 4- 节点，此时将临时 4- 节点进行分裂成 3 个 2- 节点，
此时提取 12 节点继续与父节点 5 融合，由于 5 节点是 2- 节点，那么可以直接进行融合，
融合后的 3- 节点符合 2-3 树的要求，如下：

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000123.png)
...
![DTS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000080.png)
...
![DTS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000083.png)
...
![DTS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000085.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000099.png)

如上图，12 是 2-3 树的叶子，12 与 9 构成了一个 3- 节点，因此可以直接删除 12，如下图：

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000100.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000101.png)

由于借了 9 节点之后，大小关系不满足，因此调整父节点 8 与 9，使新树满足 2-3 树的要求。
如下图：

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000102.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000103.png)

如上图，需要删除 36 节点，此时 11，18 都是 2- 节点，父节点 "15,30" 是一个 3- 节点，
将 36 节点删除之后，此时无法从兄弟节点中借到节点，因此只能从父节点中借节点，那么父节
点从 3- 节点降元成为 2- 节点，如下图：

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000104.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000105.png)

如上图，需要删除 12 节点，此时兄弟节点 8 与父节点 9 都是 2- 节点，删除 12 之后，
将 8 节点与 9 节点融合成新的节点，如下图：

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000106.png)

由于 "8-9" 节点的融合成为一个新的 3- 节点，此时会引起兄弟节点的融合，因此兄弟节点
会向上融合，与 5 节点形成一个新的 3- 节点 "2-5"。此时 2-3 树达到平衡，总体高度减少
了 1。此时删除完成，如下图：

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000107.png)

再如下面的例子，如下图。

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000108.png)

在该 2-3 树中需要删除 30 节点，此时父节点 25 与兄弟节点 22
都是 2- 节点，此时直接删除 30 节点，根据之前分析，此时兄弟节点 22 与父节点 25 合并
成一个 3- 节点，并且这个 3- 节点作为一个 "新删除的节点"。如下图：

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000109.png)

此时 "22-25" 构成新删除节点，由于此时父节点是 3- 节点，兄弟节点是 2- 节点，因此
父节点需要降元，与兄弟节点融合成 3- 节点，如下图：

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000110.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000111.png)

如上图，此时需要删除父节点 5，找到父节点 5 的前驱就是 3 节点，此时将 5 节点与 3
节点进行交换，如下图：

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000112.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000113.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000115.png)
...
![DTS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/kernel/IND00000P.jpg)
...
![DTS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000087.png)

一个 2-3 树按照上面的设定展开

![DTS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000088.png)

可以看到，将部分节点横放后，2-3 树与红黑树其实是等价的

![DTS](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/BiscuitOS/boot/BOOT000089.png)
