...
> [Github: rb_is_red](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/tree/rb-tree/API/rb_is_red)
>
...
rb_is_red() 函数判断当前 rb_node 是否为红节点。如果是则返回 1,；反之则返回 0.
函数直接调用 __rb_is_red() 函数与 rb_node 的 __rb_parent_color 成员进行
判断。

###### \_\_rb_is_red

> [\_\_rb_is_red 源码分析](https://biscuitos.github.io/blog/Tree_RBTREE___rb_is_red/#%E6%BA%90%E7%A0%81%E5%88%86%E6%9E%90)
