...
> [Github: rb_parent](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/tree/rb-tree/API/rb_parent)
>
...
rb_parent() 函数用于获得 rb_node 节点对应的父节点。在 rb_node 的定义中，成员
__rb_parent_color 用于存储父节点的地址，以及最低两位用于存储该节点的颜色。因此
__rb_parent_color 的高 30 位就是父节点的地址。
...
驱动中，使用 rb_parent() 函数可以便捷获得当前 rb_node 获得对应的父节点。
