...
> [Github: __nocast](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/sparse/API/__nocast)
>
...
__nocast 宏用于检查函数传入的数据是否与参数数据类型一直，如果不是，
sparse 则会报错。
...
drivers/BiscuitOS/sparse.c:25:14: warning: implicit cast to nocast type
