...
> [Github: __private](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/sparse/API/__private)
>
...
__private 宏用于指定私有变量，检查变量是否有效，如果无效，那么 sparse
就报错。
...
如果 __private 指向的变量无效，那么 sparse 就会报错。
