---
layout: post
title:  "__chk_user_ptr"
date:   2019-07-08 05:30:30 +0800
categories: [HW]
excerpt: sparse __chk_user_ptr().
tags:
  - Tree
---
...
> [Github: __chk_user_ptr](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/sparse/API/__chk_user_ptr)
>
...
__chk_user_ptr() 函数用于检查指针是否指向用户空间，如果不是，
那么 sparse 工具就会报警。
...
static __init int sparse_demo_init(void)
{
	...
	__chk_user_ptr(puser);
	__chk_user_ptr(pkernel);
	__chk_user_ptr(piomem);
...
drivers/BiscuitOS/sparse.c:25:24: warning: incorrect type in argument 1 (different address spaces)
drivers/BiscuitOS/sparse.c:25:24:    expected void const volatile [noderef] <asn:1> *
drivers/BiscuitOS/sparse.c:25:24:    got unsigned long *pkernel
drivers/BiscuitOS/sparse.c:26:24: warning: incorrect type in argument 1 (different address spaces)
drivers/BiscuitOS/sparse.c:26:24:    expected void const volatile [noderef] <asn:1> *
drivers/BiscuitOS/sparse.c:26:24:    got unsigned long [noderef] <asn:2> *piomem
