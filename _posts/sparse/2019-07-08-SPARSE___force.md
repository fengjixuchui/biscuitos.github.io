...
> [Github: __force](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/sparse/API/__force)
>
...
__force 宏用于强制类型转换，没有使用 __force 的变量进行强制类型转换的
时候，sparse 会报错。
