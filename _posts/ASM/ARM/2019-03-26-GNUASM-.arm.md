...
> [GitHub ASM code: .arm](https://github.com/BiscuitOS/HardStack/tree/master/Language/Assembly/ARM-GNU-Assembly/Instruction/%5B.arm%5D)
>
...
.arm 伪指令用于指定代码是 .code 32，使用 .arm 告诉编译器指令使用 arm
的而不使用 thumb 指令。
...
.arm 告诉汇编器这里的代码都是 arm 代码而不是 thumb 代码。
