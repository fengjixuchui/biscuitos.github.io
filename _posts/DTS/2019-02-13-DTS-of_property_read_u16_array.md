---
layout: post
title:  "of_property_read_u16_array"
date:   2019-02-24 09:34:30 +0800
categories: [HW]
excerpt: DTS API of_property_read_u16_array().
tags:
  - DTS
---
...
> Github: [of_property_read_u16_array](https://github.com/BiscuitOS/HardStack/tree/master/Device-Tree/kernel/API/of_property_read_u16_array)
>
...
在 root 节点之下创建一个名为 DTS_demo 的子节点。节点默认打开。节点中包含着一个
整形数组属性。具体内容如下：
...
递。获得驱动对应的节点之后，通过调用 of_property_read_u16_array() 函数读取整形
...
[    3.534359] Arary: 0x1020 0x3040 0x5060 0x7080 0x90a0
{% endhighlight %}
