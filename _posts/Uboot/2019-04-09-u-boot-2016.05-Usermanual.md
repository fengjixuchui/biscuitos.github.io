---
layout: post
title:  "u-boot-2016.05 Usermanual"
date:   2019-04-09 17:32:30 +0800
categories: [Build]
excerpt: u-boot-2016.05 Usermanual.
tags:
  - Uboot
---
...
>
> - [编译 u-boot-2016.05](#编译 u-boot-2016.05)
>
> - [运行 u-boot-2016.05](#运行 u-boot-2016.05)
>
> - [附录](#附录)
...
获得 BiscuitOS 项目之后，可以使用 BiscuitOS 构建 u-boot-2016.05 的开发环境。开发者
只需执行如下命令就可以获得 u-boot-2016.05 完整的 BiscuitOS，如下：

{% highlight bash %}
cd BiscuitOS
make u-boot-2016.05_defconfig
make
{% endhighlight %}
...
#### <span id="编译 u-boot-2016.05">编译 u-boot-2016.05</span>
...
#### <span id="运行 u-boot-2016.05">运行 u-boot-2016.05</span>

完成上面的步骤之后，开发者就可以运行 u-boot-2016.05，使用如下命令即可：
...
![LINUXP](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/kernel/UBOOT000104.png)

至此，一个 u-boot-2016.05 已经运行，开发者可以根据自己兴趣和需求对源码进行魔改。
