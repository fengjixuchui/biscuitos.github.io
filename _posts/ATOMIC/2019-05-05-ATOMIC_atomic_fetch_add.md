...
date:   2019-05-07 07:48:30 +0800
categories: [HW]
excerpt: ATOMIC atomic_fetch_add().
tags:
  - ATOMIC
---
...
> [Github: atomic_fetch_add](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/atomic/API/atomic_fetch_add)
>
...
atomic_fetch_add() 用于获得 atomic_t 变量的原始值，并给 atomic_t 变量做
加法。在 ARMv7 中，使用 ATOMIC_OPS 宏定义了 atomic_fetch_add() 函数。开
发者可以通过编译之后的结果查看 atomic_fetch_add() 函数的实现，如下：
...
atomic_fetch_add() 函数的定义如上，参数 i 指明 atomic 变量需要增加的值；
...
atomic_fetch_add() 函数可以用于获得加法之前 atomic_t 变量的值。
