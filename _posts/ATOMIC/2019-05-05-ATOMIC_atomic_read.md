...
> [Github: atomic_read](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/atomic/API/atomic_read)
>
...
atomic_read() 函数用于读取一个 atomic 变量的值。v 参数为一个 atomic 变量的指针。
函数直接调用 READ_ONCE() 从内存中读取 atomic 变量的值。

###### READ_ONCE

> [READ_ONCE 源码分析](https://biscuitos.github.io/blog/ATOMIC_READ_ONCE/)
