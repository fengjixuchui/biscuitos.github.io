---
layout: post
title:  "atomic_fetch_add_relaxed"
date:   2019-05-07 06:48:30 +0800
categories: [HW]
excerpt: ATOMIC atomic_fetch_add_relaxed().
tags:
  - ATOMIC
---
...
> [Github: atomic_fetch_add_relaxed](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/atomic/API/atomic_fetch_add_relaxed)
>
...
{% highlight ruby %}
static inline void atomic_fetch_add_relaxed(int i, atomic_t *v)
{
        unsigned long tmp;
        int result, val;
...
static __init int atomic_demo_init(void)
{
	...
	/* Atomic add */
	val = atomic_fetch_add_relaxed(1, &BiscuitOS_counter);
