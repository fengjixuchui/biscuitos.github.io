...
layout: post
title:  "atomic_dec"
date:   2019-05-07 11:23:30 +0800
categories: [HW]
excerpt: ATOMIC atomic_dec().
tags:
  - ATOMIC
---
...
> [Github: atomic_dec](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/atomic/API/atomic_dec)
>
...
atomic_dec() 函数用于给 atomic_t 变量减一操作。函数直接调用 atomic_sub()
函数实现减一操作。

###### atomic_sub

> [atomic_sub 源码分析](https://biscuitos.github.io/blog/ATOMIC_atomic_sub/)
