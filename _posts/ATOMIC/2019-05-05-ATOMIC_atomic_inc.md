...
layout: post
title:  "atomic_inc"
date:   2019-05-07 10:42:30 +0800
categories: [HW]
excerpt: ATOMIC atomic_inc().
tags:
  - ATOMIC
---
...
> [Github: atomic_inc](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/atomic/API/atomic_inc)
>
...
atomic_inc() 函数用于对 atomic_t 变量加一操作。参数 v 是指向 atomic_t 的指针。
函数直接调用 atomic_add() 函数对 atomic_t 变量增加 1.

###### atomic_add

> [atomic_add 源码分析](https://biscuitos.github.io/blog/ATOMIC_atomic_add/)
