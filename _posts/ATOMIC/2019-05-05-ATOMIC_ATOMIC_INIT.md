...
layout: post
title:  "ATOMIC_INIT"
date:   2019-05-05 15:30:30 +0800
categories: [HW]
excerpt: ATOMIC ATOMIC_INIT().
tags:
  - ATOMIC
---
...
> [Github: ATOMIC_INIT](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/atomic/API/ATOMIC_INIT)
>
...
ATOMIC_INIT() 宏用于初始化一个 atomic 变量。每当声明一个 atomic 变量之后，需要
使用 ATOMIC_INIT() 宏进行初始化。
...
初始化 atomic 变量需要使用 ATOMIC_INIT 进行初始化。
