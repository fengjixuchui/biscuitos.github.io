...
> [Github: ida_alloc](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/IDA/API/ida_alloc)
>
...
ida_alloc() 函数用于从 IDA 中分配一个 ID。参数 ida 指向 IDA；参数 gfp 指向
分配时所需的标识。函数直接调用 ida_alloc_range() 函数在 0 到 ~0 之间分配一个
可用的 ID。
