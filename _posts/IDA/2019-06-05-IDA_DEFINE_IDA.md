...
> [Github: DEFINE_IDA](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/IDA/API/DEFINE_IDA)
>
...
DEFINE_IDA 宏用于定义并初始化 struct ida 结构。内核中经常使用这个宏来定义一个
IDA。内核通过 IDA_INIT 宏初始化 struct ida 结构。
