---
layout: post
title:  "ida_simple_remove"
date:   2019-06-05 05:30:30 +0800
categories: [HW]
excerpt: IDA ida_simple_remove().
tags:
  - Tree
---
...
> [Github: ida_simple_remove](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/IDA/API/ida_simple_remove)
>
...
ida_simple_remove() 函数用于释放一个 ID。参数 ida 指向 IDA；参数 id 指向需要
释放的 ID。函数直接调用 ida_free() 函数进行 ID 释放。
