---
layout: post
title:  "ida_simple_get"
date:   2019-06-05 05:30:30 +0800
categories: [HW]
excerpt: IDA ida_simple_get().
tags:
  - Tree
---
...
> [Github: ida_simple_get](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/IDA/API/ida_simple_get)
>
...
ida_simple_get() 函数用于获得一个未使用的 ID。ida 参数对应 IDA；参数 start
指定起始 ID；参数 end 指定结束 ID；参数 gfp 指向内存分配时的标志。函数
最终调用 ida_alloc_range() 函数进行分配。
