...
> [Github: ida_is_empty](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/IDA/API/ida_is_empty)
>
...
ida_is_empty() 函数用于判断 IDA 是否为空。当 IDA radix-tree 为空，那么 IDA
就是空的，所以函数通过调用 radix_tree_empty() 函数检查 IDA radix-tree 是否
为空。
