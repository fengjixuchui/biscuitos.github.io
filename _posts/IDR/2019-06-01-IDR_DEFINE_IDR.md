...
> [Github: DEFINE_IDR](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/IDR/API/DEFINE_IDR)
>
...
DEFINE_IDR 宏定义并初始化了一个 IDR。宏通过声明了一个 struct idr 结构，
并调用 IDR_INIT 初始化了该结构。
