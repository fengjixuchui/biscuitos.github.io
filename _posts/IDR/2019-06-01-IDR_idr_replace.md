...
> [Github: idr_replace](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/IDR/API/idr_replace)
>
...
static __init int idr_demo_init(void)
{
	...
	idr_replace(&BiscuitOS_idr, &node4, idr_array[1]);
	printk("Replace %d\n", idr_array[1]);
