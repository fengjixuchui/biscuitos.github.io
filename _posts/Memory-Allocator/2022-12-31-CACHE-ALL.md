...
**CLFLUSH** 指令基于虚拟地址, 如果 CACHE Line 的状态是 Modify，那么先执行 Write-Back 将 CACHE Line 内容刷新到内存里，然后将包含内容的 CACHE Line 全部置为 Invalid. 接下来通过一个实践案例讲解如何使用该指令, 其在 BiscuitOS 上的部署逻辑如下:
