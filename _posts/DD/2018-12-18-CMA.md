...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000189.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000190.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000191.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000192.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000193.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000171.png)

接着选择并进入 "CMA: Contiguous Memory Allocator  --->"

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000172.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000174.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000175.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000176.png)

系统启动过程中，内核输出 CMA 区域创建的信息:

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000177.png)

可以看出通过 CMDLINE 配置 CMA 区域的从 0x69400000 起始分配了 4M 物理
内存空间。系统运行之后，查看系统内存布局情况:

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000178.png) 

从上面的信息可以知道系统 CMA 总共 4096KB，即 4M。当前可用的 CMA 连续物理
内存为 2304KB. 接着安装实践所使用的 CMA 驱动和应用程序，运行情况如下:

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000179.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000180.png)

驱动实践文件包含了上面几个文件，每个文件的描述如下:

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000181.png)

0001-CMA-export-sympol.patch 文件是为了让驱动运行起来内核必须打的补丁，
其核心内容就是将 "dma_alloc_from_contiguous" 和 "dma_release_from_contiguous"
两个函数到处供给其他外部驱动使用。

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000182.png)

Kconfig 文件适用于驱动在 Kbuild 中的描述和宏开关，当将驱动编译进内核，
可以使用该文件定义的宏控制驱动的开关.

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000183.png)

Makefile 文件提供了驱动外部编译的编译逻辑，使用这个编译逻辑可以独立于
内核源码树进行外部编译。

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000184.png)
...
![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000185.png)

应用程序实践文件包含了上面几个文件，每个文件的描述如下:

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000186.png)

cma.sh 脚本文件包含了 CMA 应用程序的基本使用方法，由于应用程序
依赖驱动，因此应用程序运行之前确保驱动已经安装.

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000187.png)

Makefile 包含了 CMA 应用程序的编译逻辑，可以使用该逻辑交叉编译所使用
的 CMA 应用。

![](https://gitee.com/BiscuitOS_team/PictureSet/raw/Gitee/HK/HK000188.png)
