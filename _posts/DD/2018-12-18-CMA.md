...
>   - [CMA 核心数据结构](#E03)
>
>   - [CMA 分配器内核宏](/blog/CMA-layout/#C01)
>
> - [CMA 实践部署](#B0)
>
...
>   - [工程部署 CMA](#B01)
>
>   - [CMA 配置实践之 DTS](/blog/CMA-layout/#C02)
>
>   - [CMA 配置实践之 CMDLINE](/blog/CMA-layout/#C03)
>
>   - [CMA 配置实践之 Kbuild](/blog/CMA-layout/#C04)
>
>   - [实践布局一块新的 CMA 区域](/blog/CMA-layout)
>
>   - [多块 CMA 区域实践](/blog/CMA-Mult/#B0)
>
>   - [实践最大 CMA 区域](/blog/CMA-MAX/#B0)
>
> - [CMA 分配器进阶研究](#D0)
>
>   - [CMA 区域配置之 DTS](/blog/CMA-layout/#C02)
>
>   - [CMA 区域配置之 CMDLINE](/blog/CMA-layout/#C03)
>
>   - [CMA 区域配置之 Kbuild](/blog/CMA-layout/#C04)
>
>   - [CMA 布局深入研究](/blog/CMA-layout)
>
>   - [CMA 碎片问题深入研究](/blog/CMA-hole/)
>
>   - [CMA 支持多块 CMA 区域深入研究](/blog/CMA-Mult/)
>
>   - [CMA 最大 CMA 区域问题研究](/blog/CMA-MAX/)
>
> - [附录](#附录)
...
> - [CONFIG_CMA_AREAS](/blog/CMA-layout/#C011)
...
> - [\_\_reserved_mem_check_root](#E0100)
>
> - [of_fdt_device_is_available](/blog/DTS-of_device_is_available/)
>
> - [\_\_reserved_mem_reserve_reg](#E0101)
>
> - [of_get_flat_dt_prop](/blog/DTS-of_get_flat_dt_prop/)
...
> - [cma_init_reserved_mem](#E0107)
>
> - [memblock_end_of_DRAM](/blog/MMU-ARM32-MEMBLOCK-memblock_information/#memblock_end_of_DRAM)
>
> - [memblock_is_region_reserved](/blog/MMU-ARM32-MEMBLOCK-memblock_information/#memblock_is_region_reserved)
>
...
> - [DTS 方案配置 CMA 区域](/blog/CMA-layout/#C02)
>
> - [CMALINE 方案配置 CMA 区域](/blog/CMA-layout/#C03)
>
> - [KBuild 方案配置 CMA 区域](/blog/CMA-layout/#C04)
...
> - [CONFIG_CMA](/blog/CMA-layout/#C010)
>
> - [CONFIG_CMA_AREAS](/blog/CMA-layout/#C011)
>
> - [CONFIG_DMA_CMA](/blog/CMA-layout/#C012)
>
> - [CONFIG_CMA_ALIGNMENT](/blog/CMA-layout/#C019)
