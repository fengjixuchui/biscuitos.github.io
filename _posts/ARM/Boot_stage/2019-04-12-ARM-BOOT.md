...
![MMU](https://raw.githubusercontent.com/EmulateSpace/PictureSet/master/BiscuitOS/boot/BOOTCP5C0.png)
...
数值。如果该值为 0，那么，开发者可以在上面适当位置加入断点，然后使用 GDB 进行调试，调试情况如下：
...
这段代码就是选择指定的 LoC cache，可以从 mcr 指令开始分析，第一个 mcr 指令对应的 CP15 C0
寄存器布局如下：
...
这里用于选择 Cache 的级数，从一开始的代码，"add r2, r10, r10, lsr #1", r10
