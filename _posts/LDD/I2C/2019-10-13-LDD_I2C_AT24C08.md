...
## <span id="B01">AT24C08 BiscuitOS-RaspberryPi 实践部署</span>
...
{% highlight bash %}
make
cd output/RaspberryPi_4B/package/LDD_at24c08_module-0.0.1/
make prepare
make download
make
make install
...
接下来是将模块更新到 RaspberryPi 4B 上，跟新的方式多种方式，可以参考下面
方式：

> - [BiscuitOS NFS 方式更新模块]()
>
> - [BiscuitOS SD 卡方式更新模块]()
>
> - [BiscuitOS Image 硬刷式更新模块]()
...
## <span id="B02">AT24C08 工程实践部署</span>
...
接下来是将模块更新到项目平台上，跟新的方式多种方式，可以参考下面
方式：
