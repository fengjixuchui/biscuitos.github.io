---
layout: post
title:  "list_for_each_entry"
date:   2019-05-04 11:55:30 +0800
categories: [HW]
excerpt: Bidirect-list list_for_each_entry().
tags:
  - Bidirect-list
---
...
> [Github: list_for_each_entry](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/list/bindirect-list/API/list_for_each_entry)
>
...
list_for_each_entry() 函数用于遍历内嵌双链表的结构。pos 参数指向当前遍历到的结构指针；
参数 head 指向双链表的表头；member 参数指向双链表在结构中名字。函数使用 for 循环正序
遍历所有的成员，首先使用 list_first_entry() 函数获得第一个成员，然后使用
list_next_entry() 函数获得下一个成员。

###### list_first_entry

> [list_first_entry 源码分析](/blog/LIST_list_first_entry/)
...
list_for_each_entry() 函数适用于遍历内嵌双链表的结构。
