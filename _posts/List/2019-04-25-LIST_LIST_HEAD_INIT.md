---
layout: post
title:  "LIST_HEAD_INIT"
date:   2019-04-25 18:09:30 +0800
categories: [HW]
excerpt: Bidirect-list LIST_HEAD_INIT().
tags:
  - Bidirect-list
---
...
> [Github: LIST_HEAD_INIT](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/list/bindirect-list/API/LIST_HEAD_INIT)
>
...
LIST_HEAD_INIT 宏用于给一个 struct list_head 表头初始化，将 struct list_head
的 prev 和 next 成员都指向它自己。
...
static struct list_head BiscuitOS_list = LIST_HEAD_INIT(BiscuitOS_list);
...
通过 LIST_HEAD_INIT 创建了一个双链表的表头，然后向链表中添加成员，最后
打印处出所有成员。
