...
layout: post
title:  "list_empty"
date:   2019-04-26 10:12:30 +0800
categories: [HW]
excerpt: Bidirect-list list_empty().
tags:
  - Bidirect-list
---
...
> [Github: list_empty](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/list/bindirect-list/API/list_empty)
>
...
list_empty() 函数用于判断一个链表是否为空链表。在一个链表中，如果 head 的
next 指向自己，那么这个链表就是一个空链表。
