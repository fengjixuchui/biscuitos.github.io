...
date:   2019-04-26 10:23:30 +0800
categories: [HW]
excerpt: Bidirect-list list_empty_careful().
tags:
  - Bidirect-list
---
...
> [Github: list_empty_careful](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/list/bindirect-list/API/list_empty_careful)
>
...
list_empty_careful() 函数判断一个链表是否为空链表，并确定其他 CPU 并未修改过链表
表头的 prev 和 next 成员。
...
static __init int bindirect_demo_init(void)
{
	...
	if (!list_empty_careful(&BiscuitOS_list)) {
