...
layout: post
title:  "list_add_tail"
date:   2019-04-26 07:34:30 +0800
categories: [HW]
excerpt: Bidirect-list list_add_tail().
tags:
  - Bidirect-list
---
...
> [Github: list_add_tail](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/list/bindirect-list/API/list_add_tail)
>
...
list_add_tail() 函数将一个新节点加入到链表的末尾。函数通过调用 __list_add()
函数，并将新节点插入的位置设置为 head->prev，因此新节点被加入到链接的末尾。

##### __list_add

> [\_\_list_add 源码](/blog/LIST___list_add)
...
通过 list_add_tail() 函数添加的节点都被添加到链表的末尾，因此在实际需求中如果要
倒序添加节点的话，可以使用这个函数。
