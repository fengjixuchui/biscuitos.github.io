---
layout: post
title:  "__list_cut_position"
date:   2019-04-26 13:50:30 +0800
categories: [HW]
excerpt: Bidirect-list __list_cut_position().
tags:
  - Bidirect-list
---
...
> [Github: __list_cut_position](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/list/bindirect-list/API/__list_cut_position)
>
...
__list_cut_position() 函数用于剪切一个链表。函数将 head 链表从 entry 处剪短，
被剪短的节点从 head 链表的第一个节点到 entry 节点被拼接到 list 链表里。
head 链表重新指向 entry 的下一个节点。
...
static __init int bindirect_demo_init(void)
{
	...
	__list_cut_position(&BiscuitOS_blist, &BiscuitOS_list, &node3.list);
...
__list_cut_position() 函数经常用于剪切一个链表。
