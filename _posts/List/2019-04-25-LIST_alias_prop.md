...
> [Github: alias_prop](https://github.com/BiscuitOS/HardStack/tree/master/Algorithem/list/bindirect-list/core/alias_prop)
>
...
内核在 drivers/of/base.c 里定义了一个双链表，用于维护 DTS 中所有的别名节点。内核
为 aliases_lookup 链表添加了多个接口，如下：

> of_alias_add: 添加一个新的别名节点。
>
> of_alias_get_id: 获得节点对应的别名 id。
>
> of_alias_get_alias_list: 通过 device_id 获得对应的别名列表。
>
> of_alias_get_highest_id: 获得最大别名 id。
...
通过 alias_prop 链表可以获得 DTS 中所有别名节点的信息。
